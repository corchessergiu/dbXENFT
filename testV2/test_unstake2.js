...
describe("Test unstake functionality", async function() {
    ...
    it("Basic unstake case", async function() {
        ...
        expect(await dbXeNFTFactory.dbxenftWithdrawableStake(1)).to.equal(ethers.utils.parseEther("111"));
        ...
        expect(withdrawableToken1Alice).to.equal(ethers.utils.parseEther("112"));
